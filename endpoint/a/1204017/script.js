...
function panggil(long, lat) {
    ...
    var raw = JSON.stringify({
        "api-key" : "7tSStIrPFZudxbPZZ0OLZa87QL9iLHDnyYCIbgzt1el1Q28WMzGqqAq5A5Qc8UJA",
        "long" :  long,
        "lat": lat
      } );
    ...
    fetch("https://asia-south1.gcp.data.mongodb-api.com/app/giyijisin-yfebh/endpoint/geojson", requestOptions)
        .then(response => response.text())
        .then(result => hasil(result))
        .catch(error => console.log('error', error));

    fetch("https://asia-south1.gcp.data.mongodb-api.com/app/giyijisin-yfebh/endpoint/gymbud", requestOptions)
        .then(response => response.text())
