...
function panggil(long, lat) {
    ...
    var raw = JSON.stringify({
        "api-key": "yDtt8ttZdg0jN7koBzfmLsCvAsUFeRcSuid4p3IOtKe1ZNvrrL5Rtdtz2TW0sOSO",
        "long": long,
        "lat": lat
    });
    ...
    fetch("https://asia-south1.gcp.data.mongodb-api.com/app/geojson-zzoas/endpoint/sibolga", requestOptions)
        .then(response => response.text())
        .then(result => hasil(result))
        .catch(error => console.log('error', error));

    fetch("https://asia-south1.gcp.data.mongodb-api.com/app/geojson-zzoas/endpoint/geosibolga", requestOptions)
        .then(response => response.text())
